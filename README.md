...
| 🌐 Multiplayer | P2P WebRTC (PeerJS) — visit friends' islands in real time |
...
2. Share your **Island Code** with a friend
3. Friend enters your code → visits your island!
...
- [PeerJS 1.5.2](https://peerjs.com/) — WebRTC P2P multiplayer
